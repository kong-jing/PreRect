...
final class CameraConfigurationManager {
	 ...
	 * @since JDK 1.7
	 */
	public int setCameraParametersForPreviewCallBack(Camera camera,
			int caremaId, int previewW, int previewH) {
		Camera.Parameters parameters = camera.getParameters();
		...
		if (localSize != null) {
			Log.e(TAG, "setPreviewSize width="
					+ localSize.width + "height=" + localSize.height);
...

	{
		...
		public int compare(Size paramSize1, Size paramSize2) {
			return Math.abs(paramSize1.width * paramSize1.height - this.w
					* this.h)
					- Math.abs(paramSize2.width * paramSize2.height - this.w
							* this.h);
		}
